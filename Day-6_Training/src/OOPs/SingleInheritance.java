...
class onlineOrder extends order{
	...
	public onlineOrder(String orderId, double amount, String trackingId) {
		super(orderId, amount);
		this.trackingId = trackingId;
	}
	public void trackOrder() {
		display();
		System.out.println("TrackingNumber: " + trackingId);
	}
}
...
public class SingleInheritance {
	...
	public static void main(String[] args) {
		onlineOrder or = new onlineOrder("Order101", 3500, "TR420");
		or.trackOrder();
