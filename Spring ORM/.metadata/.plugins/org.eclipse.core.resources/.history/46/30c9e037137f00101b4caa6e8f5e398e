...
public class App 
{
    public static void main( String[] args )
    {
     // to get the session from sessionfactory (It can be multiple session based on multiple services or work)
     	   ...
     	   Employee emp = new Employee( null, "giya","giya@gmail.com"); //transaction	
...
//     	  System.out.println("The size is: "+e);
     	...
     	Employee emp1 = new Employee( null, "Riya","Riya@gmail.com"); //transaction	
