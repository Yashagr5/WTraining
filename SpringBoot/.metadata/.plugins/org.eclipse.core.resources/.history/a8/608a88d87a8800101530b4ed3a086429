...
public class AdminController {
    ...
    public String addTask(@ModelAttribute Task task,
            @RequestParam(value = "assignedUser", required = false) Long userId) {
    		User user = null;
    		...
    		if (userId != null) {
    			...
    			// ✅ fallback: assign first available user (or an admin)	
    			List<User> users = userService.getAllUsers();
    			if (!users.isEmpty()) {
    ...
    public String viewComments(@PathVariable Long taskId, Model model) {
        ...
        return "admin/comments"; // ✅ points to admin/comments.html
    }
    ...
    public String addComment(@RequestParam Long taskId,
        ...
        // 🔹 later you can fetch the logged-in admin from session
 ...
 // ================= Show All Comments =================
    ...
    public String viewAllComments(Model model) {
        ...
        return "admin/view-all-comments"; // points to the HTML you shared
    }
}
