...
public class UserController {
 ...
 // ================== MY TASKS PAGE ==================
    ...
    public String myTasks(Model model, Principal principal) {
        ...
        return "user/tasks";  // 👈 maps to your user/tasks.html
    }
 ...
 // ================== UPDATE TASK STATUS ==================
    ...
    public String updateTaskStatus(@RequestParam Long taskId,
        ...
        taskService.getTaskById(taskId).ifPresent(task -> {
            // ✅ Check if the logged-in user is one of the assigned users
 ...
 // ================= Show Task Comments =================
    ...
    public String viewComments(@RequestParam("taskId") Long taskId, Model model) {
        ...
        return "user/comments"; // comments.html
    }
    ...
    public String addComment(@RequestParam("taskId") Long taskId,
        ...
        comment.setCommentText(content);   // matches your HTML
        ...
        // redirect back to same task comments page
