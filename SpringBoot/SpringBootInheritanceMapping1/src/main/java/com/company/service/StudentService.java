...
public class StudentService {
	...
	public StudentService(StudentRepo students, TeacherRepo teachers) {
		super();
		...
		public List<Student_DTO> allStudents_DTO()
	{
		...
		public List<Teacher_DTO> allteachers_DTO()
		{
				return (List<Teacher_DTO>) teachers.findAllTeachers().stream()
